...
public class Group{
    ...
    public String speak (String groupName, ArrayList<AbstractMap.SimpleEntry<String, Double>> answers, String questionDescription){
        int num = answers.size();
        StringBuilder output = new StringBuilder("На вопрос \"");

        output.append(questionDescription);
        output.append("\" группа " + groupName);
